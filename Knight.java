...
/**
 * Knight implements a Piece with the rank of Knight.
 */

public class Knight implements Piece {

    private static final String RANK = "KNIGHT";
    private static final String PIECE_PNG = "Knight.png";
    ...
    public Knight(String color, Square initialSquare, Image image, DrawingCanvas
            canvas) {
